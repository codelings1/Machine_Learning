...
def getPrediction():
  in_sentences = []
  in_sentences.append(request.json['testData'])
  ...
  response = json.dumps({"response": [(labels[prediction['labels']]) for sentence, prediction in zip(in_sentences, predictions)]})
  print(response)
  return response 
